    ...
    <div style={{ padding: 24, maxWidth: 1100 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(150px,1fr))', gap: 14, marginBottom: 28 }}>
        {Array.from({length: 4}).map((_,i) => (
          <div key={i} style={{ height: 90, borderRadius: 14, background: 'linear-gradient(90deg,#111827 25%,#1e293b 50%,#111827 75%)', backgroundSize: '200% 100%', animation: `anShimmer 1.4s ${i*0.15}s infinite` }} />
        ))}
      </div>
    </div>
  );
