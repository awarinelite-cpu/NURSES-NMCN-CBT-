...
const styles = {
  ...
  courseCard:  { display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '18px 12px 14px', borderRadius: 14, border: '1.5px solid', fontFamily: F, transition: 'all 0.18s', background: 'var(--bg-card)' },
