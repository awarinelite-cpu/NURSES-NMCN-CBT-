...
import {
  collection, getDocs, query, where, addDoc, serverTimestamp, deleteDoc, doc,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h3 style={{ textAlign: 'center', margin: '0 0 8px', fontSize: 18, fontWeight: 900 }}>Exit Drill?</h3>
        <p style={{ textAlign: 'center', color: 'var(--text-muted)', margin: '0 0 16px' }}>
          Progress saved. Returning to Dashboard...
        </p>
...
export default function EntranceSubjectSession() {
  ...
  // Load questions (resume + normal) — keep your existing logic here...
  ...
  const handleSaveExit = useCallback(async () => {
    ...
    try {
      await addDoc(collection(db, 'entrancePausedExams'), {
        ...
        examName: `${subject?.name || 'Subject'} Drill`,
  ...
  // ... rest of your component (timer, question rendering, etc.)
