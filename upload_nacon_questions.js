// NACON POST-UTME 2021 — Upload 100 questions to Firestore
// Run once: node upload_nacon_questions.js
...
const QUESTIONS = [
  ...
  { question: "He could not have rewarded them more handsomely. What does this mean?", options: ["He rewarded them very well.","He did not reward them very well.","He spoke to them in very generous way.","He rewarded them well, and he is also a good-looking man."], correctIndex: 0, subject: "English Language", topic: "Comprehension" },
  ...
  { question: "A body of mass 100g moving at 10.0 m/s collides with a wall and moves at 2m/s in the opposite direction. Calculate the change in momentum.", options: ["0.8 Ns","1.2 Ns","12.0 Ns","80.0 Ns"], correctIndex: 1, subject: "Physics", topic: "Mechanics" },
  { question: "Find the tension T in the diagram if the system is in Equilibrium.", options: ["200/3 N","100/3 N","300/3 N","100 N"], correctIndex: 2, subject: "Physics", topic: "Mechanics" },
  ...
  { question: "A wheel and axle have radii 80cm and 10cm. Efficiency is 0.85 and applied force is 1200N. What load will the wheel raise?", options: ["8.0N","6.8N","816N","9600.0N"], correctIndex: 2, subject: "Physics", topic: "Machines" },
  { question: "A body under a force with semi-circular force-displacement graph moves 24 metres. What is the work done?", options: ["36 nJ","72 nJ","144 nJ","288 nJ"], correctIndex: 2, subject: "Physics", topic: "Energy" },
  { question: "A 20kg mass is pulled up a 30-degree slope. Efficiency is 75%. What force is required? (g=10ms-2)", options: ["13.3N","73.5N","133.3N","533.2N"], correctIndex: 2, subject: "Physics", topic: "Machines" },
  ...
  { question: "A stone's mass is 15.0g in water and 10.0g in liquid of relative density 2.0. What is its mass in air?", options: ["5.0g","12.0g","20.0g","25.0g"], correctIndex: 3, subject: "Physics", topic: "Hydrostatics" },
  { question: "A pilot records 63cm Hg pressure and ground observer records 75cm Hg. Calculate height of plane. (Relative density of Hg=13.0, density of air=0.00013)", options: ["1200m","6300m","7500cm","13800m"], correctIndex: 1, subject: "Physics", topic: "Pressure" },
  ...
  { question: "Trees that are resistant to fire and drought are commonly found in the _____.", options: ["Tropical rainforest","Savanna","Desert","Montane forest"], correctIndex: 1, subject: "Biology", topic: "Ecology" },
  ...
  { question: "If the gall bladder of a mammal is damaged, which of the following will be most seriously affected?", options: ["Glycolysis","Digestion of starch","Digestion of fats","Digestion of protein"], correctIndex: 2, subject: "Biology", topic: "Nutrition and Digestion" },
  ...
  { question: "A piece of cloth was measured as 6.10m but actual length is 6.35m. Find the percentage error correct to 2 decimal places.", options: ["3.05%","3.94%","15.00%","25.00%"], correctIndex: 1, subject: "Mathematics", topic: "Approximation and Error" },
  ...
  { question: "Which is the odd-one-out?", options: ["Air","Sand","Urine","Blood"], correctIndex: 0, subject: "Chemistry", topic: "Separation Techniques" },
...
async function uploadAll() {
  console.log(`Uploading ${QUESTIONS.length} questions to Firestore...`);
  ...
  for (let i = 0; i < QUESTIONS.length; i++) {
    ...
    try {
      ...
      success++;
      console.log(`✓ [${i+1}/100] ${q.subject} — ${q.question.substring(0,55)}...`);
    } catch (err) {
      failed++;
      console.error(`✗ [${i+1}/100] FAILED: ${err.message}`);
    }
  }

  console.log(`\n========================================`);
  console.log(`Done! ${success} uploaded, ${failed} failed.`);
  console.log(`Delete this file from the repo after running.`);
  process.exit(0);
}
